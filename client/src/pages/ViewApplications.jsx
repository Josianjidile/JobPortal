              ...
              <tr className="text-gray-700">
                ...
                <td className="py-2 px-4 border-b relative">
                    <div className=" relative inline-block text-left group">
                       ...
                       <div className=" block w-full text-left px-4 py-2 text-blue-500 hover:bg-gray-100">Accept</div>
                       <div className=" block w-full text-left px-4 py-2 text-red-500 hover:bg-gray-100">Reject</div>
                       </div>
                    </div>
                </td>
              </tr>
